...
contract DeployLandRegistryMultiSig is Script {
    function run() external {
        ...
        initialAuthorities[0] = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266; // Otoritas 1 (Biasanya Deployer)
        initialAuthorities[1] = 0x70997970C51812dc3A010C7d01b50e0d17dc79C8; // Otoritas 2
        initialAuthorities[2] = 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC; // Otoritas 3
